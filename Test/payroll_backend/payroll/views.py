...
class EmployeeCreateView(APIView):
    ...
    def post(self,request):
        ...
        if employeereport:
            return Response({"data":"","message":"Dumplicate report found !!"},status=status.HTTP_200_OK)
        ...
        return Response({"data":serializer.data,"message":"successfully uploaded"},status=status.HTTP_200_OK)
